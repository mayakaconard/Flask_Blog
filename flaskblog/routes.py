...
posts= [
    {
        ...
        'title':'Blog posting',
        'content': 'Hello there... this is the first blog',
...
def save_picture(form_picture):
    ...
    picture_path = os.path.join(app.root_path, 'static/profpics', picture_fn)
    output_size = (125, 125)
...
def account():
    ...
    image_file = url_for('static', filename='profpics/'+ current_user.image_file)
